...
module.exports = { name:"bonk", category:"reactions", description:"bonk (image)",
  async execute(sock,msg){ try{ const r=await fetch("https://api.waifu.pics/sfw/bonk"); const d=await r.json();
