...
module.exports = { name:"wave", category:"reactions", description:"wave (image)",
  async execute(sock,msg){ try{ const r=await fetch("https://api.waifu.pics/sfw/wave"); const d=await r.json();
